...
bh = boxplot(data,G,...
    ...
    'color',[0.8 0.8 0.8],'jitter',outlier_jitter_value,...
...
%% Coloring each box
box_color = repmat([0.85 0.85 0.85],[12,1]);
box_color_transparency = 1;
...
%% Adjusting median
%median_color = flipud([0 0.7 0.8 ;0 0.7 0.6; 0.9 0.8 0.2; 0.9 0.6 0.2; 0.9 0.5 0.7; 1 0.3 0.4]);
median_color = repmat([0.5 0.5 0.5],[12,1]);
h=findobj(gca,'tag','Median');
for kk = 1:length(h)
    h(kk).LineWidth = median_lineWidth;
    h(kk).Color = median_color(kk,:);
end
